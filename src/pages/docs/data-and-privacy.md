...
|---|---|
| Familiarization | The first sixty thousand characters of each source, verbatim |
| Coding, initial coding, applying a codebook, charting | Every source in full, verbatim, in segments of twenty-four thousand characters |
| Codebook derivation, in inductive content analysis | A sample from the beginning of each source, verbatim |
...
| Structured extraction, in literature synthesis | Every paper in full, verbatim, in segments of twenty-four thousand characters, then the per-part notes for consolidation |
...
Anyone with read access to those two paths has your data. Everything in that table is synced as well if your QualiLens folder sits inside a cloud-synced directory.
...
Decide whether your project folder should be excluded from cloud sync, and exclude it before the first upload rather than after.
